...
<head>
	<meta charset="UTF-8">
	<title>王建的个人网站</title>
	<link rel="stylesheet" href="assets/fonts/glyphicons/css/glyphicons.css">
		...
		<div class="carousel">
			<div class="carousel-imgs">
				<div class="carousel-item">
					...
					<img class="carousel-img" src="assets/img/55.jpg" alt="">
				</div>
				<div class="carousel-item">
					<div class="carousel-txt">
						<h3>2222Special Offer</h3>
						<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
						<h5>Voucher: ABC-DEF123X</h5>
						<a href="#">
							<span class="glyphicon glyphicon-shopping-cart"></span>
					...
					<img class="carousel-img" src="assets/img/56.jpg" alt="">
				</div>
				<div class="carousel-item">
					<div class="carousel-txt">
						<h3>Special Offer</h3>
